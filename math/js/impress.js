...
(function ( document, window ) {
    ...
    var addToolbarButton = function (toolbar) {
        var html = '<button id="impress-autoplay-playpause" title="自动放映" class="impress-autoplay">' + getButtonText() + '</button>';
...
(function ( document, window ) {
    ...
    triggerEvent(document, "impress:help:add", { command : "H", text : "显示/关闭帮助信息", row : 0} );
...
(function ( document, window ) {
    ...
    document.addEventListener("impress:init", function (event) {
        ...
        triggerEvent(document, "impress:help:add", { command : "左&amp;右方向键", text : "上一页 &amp; 下一页", row : 1} );
...
(function ( document, window ) {
    ...
    var addNavigationControls = function( event ) {
        ...
        var prevHtml   = '<button id="impress-navigation-ui-prev" title="上一页" class="impress-navigation-ui">&lt;</button>';
        var selectHtml = '<select id="impress-navigation-ui-select" title="跳转到" class="impress-navigation-ui">' + "\n"
                           + options
                           + '</select>';
        var nextHtml   = '<button id="impress-navigation-ui-next" title="下一页" class="impress-navigation-ui">&gt;</button>';
